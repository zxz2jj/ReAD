...
if __name__ == "__main__":
    ...
    # train fmnist model. If model is existed, it will show the information of model
    show_model = False
    if show_model:
        train_models()
    ...
    OOD_dataset = ['MNIST', 'Omniglot', 'UniformNoise', 'GuassianNoise']
    for ood in OOD_dataset:
        t1 = time.time()
        print('\n************Evaluating*************')
        print('In-Distribution Data: FMNIST test data, Out-of-Distribution Data: {} test data.'.format(ood))
