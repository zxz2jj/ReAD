...
from load_data import load_gtsrb_train, load_gtsrb_test
...
def classify_train_data():
    ...
    if not gv.gtsrb_data_is_loaded:
        gv.x_train, gv.y_train_category, gv.y_train_one_hot = load_gtsrb_train()
...
def classify_test_data():
    ...
    if not gv.gtsrb_data_is_loaded:
        gv.x_test, gv.y_test_category, gv.y_test_one_hot = load_gtsrb_test()
