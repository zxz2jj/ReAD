...
def train_models():
    if not gv.gtsrb_data_is_loaded:
        gv.x_train, gv.y_train_category, gv.y_train_one_hot,\
          gv.x_test, gv.y_test_category, gv.y_test_one_hot = load_gtsrb()
        gv.cifar10_data_is_loaded = True

    gtsrb_model = GTSRBModel(train_class_number=gv.category_classified_of_model,
