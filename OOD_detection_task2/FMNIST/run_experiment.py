...
if __name__ == "__main__":
    ...
    for category_of_train in range(2, 10):
        ...
        gv.model_path = 'models/fmnist_model_0-{}.h5'.format(category_of_train-1)
        show_model = True
        if show_model:
        ...
        print('\n************Evaluating*************')
        print('In-Distribution Data: FMNIST test data category 0-{},\n '
              'Out-of-Distribution Data: FMNIST test data category {}-9.'.format(category_of_train-1, category_of_train))
