...
from load_data import load_mnist_of_given_category
...
def train_models(category_of_train):
    ...
    gv.x_train, gv.y_train_category, gv.y_train_one_hot,\
      ...
      load_mnist_of_given_category(category_of_train)

    mnist_model = MnistModel(train_class_number=gv.category_classified_of_model,
...
if __name__ == "__main__":
    for category_number in range(2, 3):
        gv.category_classified_of_model = category_number
        gv.model_path = 'models/mnist_model_0-{}.h5'.format(category_number-1)
